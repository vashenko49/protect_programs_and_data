...
namespace SecretSharing.SecretEncryption
{
    public class SharesManager
    {
        ...
        {
            var keyLengthInBits = key.Length * 16;
            var polynomsCount = key.Length;
            ...
            var counter = 0;
            for (var i = 0; i < playerPoints.GetLength(0); i++)
            {
                for (var j = 0; j < playerPoints.GetLength(1); j++)
                {
